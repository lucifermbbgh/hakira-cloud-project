package com.hakira.ledger.api.common;

import com.hakira.ledger.api.pojo.ClubUser;
import com.hakira.ledger.api.pojo.ClubUserInfo;
...
public interface ClubUserInfoService {
     ...
     * @param: clubUserInfo
     * @return: com.hakira.ledger.api.pojo.ClubUserInfo
     **/
     ...
     * @date: 2023/11/23 16:37
     * @param: clubUser
     * @return: com.hakira.ledger.api.pojo.ClubUser
     **/
     ...
     * @param: params
     * @return: java.util.List<com.hakira.ledger.api.pojo.ClubUser>
     **/
     ...
     * @date: 2023/11/23 16:34
     * @param: params
     * @return: java.util.List<com.hakira.ledger.api.pojo.ClubUserInfo>
     **/
