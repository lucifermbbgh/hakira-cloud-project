...
public class OrderMqTagFilterConsumer {
    public static void main(String[] args) {
        // 创建消费者
        DefaultMQPushConsumer consumer = new DefaultMQPushConsumer("hakira-ledger-entry-tagFilter-consumer");
        // 指定NameServer地址
        ...
        try {
            ...
            consumer.subscribe("hakira-ledger-entry-tagFilter-topic", messageSelector);
