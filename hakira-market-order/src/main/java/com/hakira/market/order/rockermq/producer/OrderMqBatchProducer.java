...
import com.hakira.market.order.rockermq.producer.splitter.MessageListSplitter;
...
public class OrderMqBatchProducer {
    public static void main(String[] args) {
        ...
        DefaultMQProducer producer = new DefaultMQProducer("hakira-market-order-batch-producer");
        // 指定 NameServer 地址
        ...
        try {
            ...
            for (int i = 0; i < 1000 * 1000; i++) {
                Message message = new Message(
                        "hakira-market-order-batch-topic",
                        "hakira-market-order-batch-tag",
                        "hakira-market-order-batch-key",
                        ("hakira-market-order-batch-body:" + i).getBytes(RemotingHelper.DEFAULT_CHARSET));
