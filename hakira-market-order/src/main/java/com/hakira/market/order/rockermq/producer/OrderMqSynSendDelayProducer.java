...
import com.hakira.market.order.pojo.dto.MarketOrderInfoDto;
...
//                Message message = new Message("hakira-market-order-topic", "hakira-market-order-tag", "hakira-market-order-key", "hakira-market-order-body".getBytes());
